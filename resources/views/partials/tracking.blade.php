@php($tracking = config('bayarea.tracking'))
@if ($tracking['gtm_id'])
    <script>
...
<script>
    ...
    gtag('config', '{{ $tracking['google_tag_id'] }}');
</script>
<script>
...
<noscript>
    <img height="1" width="1" style="display:none" alt="" src="https://www.facebook.com/tr?id={{ $tracking['meta_pixel_id'] }}&ev=PageView&noscript=1">
</noscript>
